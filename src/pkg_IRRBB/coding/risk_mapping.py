...
sheetname='transaction_level_ED'
filename = "qrm_market_value_and_exposure_derivatives_2021-12-31.xlsx"
filepath = "./data/"  + filename

df_transactions = pd.read_excel(filepath, sheet_name=sheetname, skiprows=11)  
...
###################################################################
##### Obtaining list of unique values #####
###################################################################
...
###################################################################
ws2 = wb.create_sheet("unique_lists")
...
###################################################################
# aggregate values (pivot)
###################################################################
ws3 = wb.create_sheet("risk_mapping",1)
...
wb.save(filename = f"./output/risk_mapping_{filename[-15:-5]}.xlsx")
